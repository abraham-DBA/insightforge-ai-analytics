...
const Pricing = () => {
    return (
        <section id="pricing" className="py-2 px-6 max-w-6xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                ...
                <div className="p-8 relative overflow-hidden rounded-3xl border border-white/10 bg-white/3 flex flex-col items-start text-left hover:bg-zinc-900/40 transition-colors">
                    ...
                    <div className="text-4xl font-medium text-white tracking-tight mb-4">
                        $40 <span className="text-lg text-zinc-600 font-light">/mo</span>
                    </div>
                    <ul className="space-y-3 mb-8 text-sm text-zinc-300 font-light w-full">
                        <li className="flex items-center gap-3">
                    ...
                    <button className="w-full cursor-pointer bg-white text-black py-3 rounded-xl  hover:bg-zinc-200 transition-colors text-sm font-medium mt-auto">
                        Get Started
                    </button>
